...
export function FormNav() {
  ...
  return (
    <>
            ...
            <ul className="flex flex-col">
                ...
                <li className="flex items-center justify-between p-4">
                  ...
                  <div
                    className={cn(
                      ...
                      {
                        "bg-green-400":
                          personalDataComplete && !personalDataError,
                ...
                <li className="flex items-center justify-between p-4">
                  ...
                  <div
                    className={cn(
                      ...
                      {
                        "bg-green-400":
                          contactAndAddressComplete && !contactAndAddressError,
              ...
              >
                <li className="flex items-center justify-between p-4">
                  ...
                  >
                    {passportComplete && !passportError && (
                      <Check color="#FFF" />
                    )}
                ...
                <li className="flex items-center justify-between p-4">
                  ...
                  <div
                    className={cn(
                      ...
                      {
                        "bg-green-400":
                          aboutTravelComplete && !aboutTravelError,
                ...
                <li className="flex items-center justify-between p-4">
                  ...
                  <div
                    className={cn(
                      ...
                      {
                        "bg-green-400":
                          travelCompanyComplete && !travelCompanyError,
                ...
                <li className="flex items-center justify-between p-4">
                  ...
                  <div
                    className={cn(
                      ...
                      {
                        "bg-green-400":
                          previousTravelComplete && !previousTravelError,
              ...
              >
                <li className="flex items-center justify-between p-4">
                  ...
                  >
                    {USAContactComplete && !USAContactError && (
                      <Check color="#FFF" />
                    )}
                ...
                <li className="flex items-center justify-between p-4">
                  ...
                  <div
                    className={cn(
                      ...
                      {
                        "bg-green-400":
                          workEducationComplete && !workEducationError,
              ...
              >
                <li className="flex items-center justify-between p-4">
                  ...
                  >
                    {securityComplete && !securityError && (
                      <Check color="#FFF" />
                    )}
      ...
      <div className="w-80 h-fit hidden lg:block sticky top-0 left-0">
        <ul className="flex flex-col">
          <LinkScroll
            activeClass="active"
            to="personal-data"

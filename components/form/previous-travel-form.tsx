  ...
  useEffect(() => {
    if (redirectStep !== null) {
      ...
      savePreviousTravel({
        ...
        hasVisaConfirmation: values.hasVisaConfirmation ?? (currentForm.alreadyHaveVisa ? "Sim" : "Não"),
          ...
          <div className="w-full flex flex-col">
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-x-4 gap-y-6 mb-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className={cn(americanLicenseToDriveConfirmation === "Não" && "hidden")}>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-x-4 gap-y-6 mb-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className={cn(USAVisaConfirmation === "Não" && "hidden")}>
              ...
              <FormField
                ...
                name="visaNumber"
                render={({ field }) => (
                  <FormItem className={cn("flex flex-col justify-between", USAVisaConfirmation === "Não" && "hidden")}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className={cn("mb-4 sm:mb-6", hasVisaConfirmation === "Não" && "hidden")}>
                  <FormLabel className="text-foreground">
            ...
            <div className="w-full grid grid-cols-1 gap-x-4 gap-y-6 mb-6">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className={cn(hasVisaConfirmation === "Não" && "hidden")}>
              ...
              {hasVisaConfirmation === "Sim" && lostVisaConfirmation === "Sim" && (
                <FormField
                  control={form.control}
            ...
            <div className="w-full grid grid-cols-1 gap-x-4 gap-y-6 mb-6">
              ...
              {hasVisaConfirmation === "Sim" && canceledVisaConfirmation === "Sim" && (
                <FormField
                  control={form.control}
            ...
            <div className="w-full grid grid-cols-1 gap-x-4 gap-y-6 mb-6">
              ...
              {hasVisaConfirmation === "Sim" && deniedVisaConfirmation === "Sim" && (
            ...
            <div className="w-full grid grid-cols-1 gap-x-4 gap-y-6">
              ...
              {hasVisaConfirmation === "Sim" && immigrationRequestByAnotherPersonConfirmation === "Sim" && (
                <FormField
                  control={form.control}

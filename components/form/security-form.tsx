          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-foreground">
                ...
                inguinal, hanseníase infecciosa, linfogranuloma venéreo, sífilis
                em estágio infeccioso, tuberculose ativa e outras doenças,
                conforme determinado pelo Departamento de Saúde e Serviços
                Humanos?
              </FormLabel>
      ...
      <div className="w-full grid grid-cols-1 gap-4">
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-foreground">
                Você já foi preso ou condenado por algum delito ou crime, mesmo
                que tenha sido objeto de perdão, anistia ou outra ação
                semelhante?
              </FormLabel>
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-foreground">
                ...
                envolvido em prostituição ou procura de prostitutas nos últimos
                10 anos?
              </FormLabel>
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-foreground">
                ...
                com um indivíduo que cometeu ou conspirou para cometer um crime
                grave de tráfico de pessoas nos Estados Unidos ou fora?
              </FormLabel>
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-foreground">
                ...
                Estados Unidos ou fora e, nos últimos cinco anos, beneficiou-se
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-foreground">
                ...
                controle de exportação ou qualquer outra atividade ilegal
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-foreground">
                ...
                entrada nos Estados Unidos ou qualquer outro benefício de
                imigração dos Estados Unidos por meio de fraude, deturpação
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="text-foreground">
                ...
                dos Estados Unidos de uma pessoa que recebeu a custódia legal de
                um tribunal dos EUA?
              </FormLabel>

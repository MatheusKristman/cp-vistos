          ...
          <div className="w-full flex flex-col gap-6">
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-6">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-lg font-medium text-foreground">
                  {client.form.cel ? formatPhoneNumber(client.form.cel) : "Não Preenchido"}
                </span>
              </div>
              ...
              <div className="flex flex-col">
                ...
                <span className="text-lg font-medium text-foreground">
                  {client.form.tel ? formatPhoneNumber(client.form.tel) : "Não Preenchido"}
                </span>
              </div>
            </div>
        ...
        <div className="w-full flex flex-col gap-9">
          ...
          <div className="w-full flex flex-col gap-6">
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-lg font-medium text-foreground">
                  {client.form.visitLocations.length > 0 ? client.form.visitLocations.join(" | ") : "Não Preenchido"}
                </span>
              </div>
            </div>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-lg font-medium text-foreground">
                  {client.form.USAZipCode ? client.form.USAZipCode : "Não Preenchido"}
                </span>
              </div>
            </div>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-lg font-medium text-foreground">
                  {client.form.payerTel ? formatPhoneNumber(client.form.payerTel) : "Não Preenchido"}
                </span>
              </div>
            </div>
          ...
          <div className="w-full flex flex-col gap-9">
            ...
            <div className="w-full flex flex-col gap-6">
              ...
              <div className="w-full flex flex-col gap-9">
                {client.form.americanLicenseToDriveConfirmation && client.form.americanLicense.length > 0 ? (
                  client.form.americanLicense.map((americanLicense, index) => (
                    <div key={`americanLicense-${index}`} className="w-full bg-[#FDF0D2] p-5 flex flex-col gap-4">
                      ...
                      <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div className="w-full flex flex-col gap-1">
                          <span className="text-sm text-foreground/70 font-medium">Número da licença</span>

                          <span className="text-lg font-medium text-foreground">{americanLicense.licenseNumber}</span>
                        </div>

                        <div className="w-full flex flex-col gap-1">
                          <span className="text-sm text-foreground/70 font-medium">Estado</span>

                          <span className="text-lg font-medium text-foreground">{americanLicense.state}</span>
                        </div>
                      </div>
                    </div>
                  ))
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-lg font-medium text-foreground">
                    {client.form.organizationOrUSAResidentTel
                      ? formatPhoneNumber(client.form.organizationOrUSAResidentTel)
                      : "Não Preenchido"}
                  </span>
                </div>
            ...
            <div className="w-full flex flex-col gap-6">
              ...
              <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-6">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-lg font-medium text-foreground">
                    {client.form.companyCep ? client.form.companyCep : "Não Preenchido"}
                  </span>
                </div>
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-lg font-medium text-foreground">
                    {client.form.companyTel ? formatPhoneNumber(client.form.companyTel) : "Não Preenchido"}
                  </span>
                </div>
              </div>
              ...
              <div className="w-full grid grid-cols-1 gap-6">
                <div className="flex flex-col">
                  ...
                  {/* TODO: verificar como está sendo salve e se preciso usar a function do utils para formatar em reais */}
                  <span className="text-lg font-medium text-foreground">
                    {client.form.monthlySalary ? client.form.monthlySalary : "Não Preenchido"}
                  </span>
                </div>
              </div>
                    ...
                    <div key={`previousJobs-${index}`} className="w-full bg-[#D3D3E2] p-5 flex flex-col gap-4">
                      ...
                      <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-6">
                        ...
                        <div className="w-full flex flex-col gap-1">
                          ...
                          <span className="text-lg font-medium text-foreground">
                            {previousJobs.companyTel ? formatPhoneNumber(previousJobs.companyTel) : "Não Preenchido"}
                          </span>
                        </div>
                      </div>

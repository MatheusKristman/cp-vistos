  ...
  return (
    <div className="w-full flex flex-col gap-9 bg-secondary py-6 px-8 rounded-xl sm:py-8 sm:px-11">
      ...
      <Accordion type="single" collapsible className="flex flex-col gap-6">
        <AccordionItem value="personal-data" className="bg-white p-6 sm:p-6 flex flex-col gap-9 border-0 rounded-lg">
        ...
        <AccordionItem value="contacts-and-address" className="bg-white p-6 flex flex-col gap-9 border-0 rounded-lg">
          <AccordionTrigger className="text-lg text-left text-foreground font-semibold hover:no-underline">
            Endereço e Contatos
          </AccordionTrigger>
        ...
        <AccordionItem value="passport" className="bg-white p-6 flex flex-col gap-9 border-0 rounded-lg">
          ...
          <AccordionContent className="w-full flex flex-col gap-9">
            <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Número do Passaporte</span>
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Cidade de Emissão</span>
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Estado de Emissão</span>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">País de Emissão</span>
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Data de Emissão</span>
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Data de Expiração</span>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Já perdeu ou teve o passaporte roubado?</span>
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Número do Passaporte Perdido/Roubado</span>
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">País do Passaporte Perdido/Roubado</span>
            ...
            <div className="w-full grid grid-cols-1 gap-6">
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Explique o que ocorreu</span>
        ...
        <AccordionItem value="about-travel" className="bg-white p-6 flex flex-col gap-9 border-0 rounded-lg">
          <AccordionTrigger className="text-lg text-left text-foreground font-semibold hover:no-underline">
            Sobre a Viagem
          </AccordionTrigger>
          ...
          <AccordionContent className="w-full flex flex-col gap-9">
            <div className="w-full grid grid-cols-1 sm:grid-cols-4 gap-6">
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Possui itinerário de viagem?</span>
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Data prevista de chegada nos EUA</span>
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Número do voo de chegada</span>
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Cidade de chegada</span>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Data prevista de retorno ao Brasil</span>
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Número do voo de partida</span>
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Cidade de partida</span>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Tempo estimado de permanência nos EUA</span>
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Locais que irá visitar</span>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Endereço completo onde ficará nos EUA</span>
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">ZIP Code de onde ficará nos EUA</span>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Cidade nos EUA</span>
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Estado nos EUA</span>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Nome ou empresa que pagará a viagem</span>
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Telefone Residencial</span>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Endereço Completo</span>
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Relação com o solicitante</span>
        ...
        <AccordionItem value="travel-company" className="bg-white p-6 flex flex-col gap-9 border-0 rounded-lg">
          <AccordionTrigger className="text-lg text-left text-foreground font-semibold hover:no-underline">
            Companhia de Viagem
          </AccordionTrigger>
          ...
          <AccordionContent className="w-full flex flex-col gap-9">
                ...
                form.otherPeopleTraveling.map((otherPeople, index) => (
                  <div key={`otherPeopleTraveling-${index}`} className="w-full bg-[#D3D3E2] p-5 flex flex-col gap-4">
                    <div className="w-full flex flex-col sm:flex-row items-center gap-2">
                      ...
                      <span className="text-foreground text-lg text-center font-medium">Pessoa Acompanhante</span>
                    </div>
                    ...
                    <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
                      <div className="w-full flex flex-col gap-1">
                        ...
                        <span className="text-lg font-medium text-foreground">{otherPeople.name}</span>
                      </div>

                      <div className="w-full flex flex-col gap-1">
                        <span className="text-sm text-foreground/70 font-medium">Relação com a outra pessoa</span>

                        <span className="text-lg font-medium text-foreground">{otherPeople.relation}</span>
                      </div>
                    </div>
                  </div>
                ))
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Nome da organização ou grupo</span>
        ...
        <AccordionItem value="previous-travel" className="bg-white p-6 flex flex-col gap-9 border-0 rounded-lg">
          <AccordionTrigger className="text-lg text-left text-foreground font-semibold hover:no-underline">
            Viagens Anteriores
          </AccordionTrigger>
          ...
          <AccordionContent className="w-full flex flex-col gap-9">
            <div className="w-full grid grid-cols-1 gap-6">
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Já foi para os EUA?</span>
                ...
                form.USALastTravel.map((lastTravel, index) => (
                  <div key={`USALastTravel-${index}`} className="w-full bg-[#D3D3E2] p-5 flex flex-col gap-4">
                    <div className="w-full flex flex-col sm:flex-row items-center gap-2">
                      ...
                      <span className="text-foreground text-lg text-center font-medium">Viagem</span>
                    </div>

                    <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
                      <div className="w-full flex flex-col gap-1">
                        <span className="text-sm text-foreground/70 font-medium">Data prevista de chegada nos EUA</span>
                      ...
                      <div className="w-full flex flex-col gap-1">
                        ...
                        <span className="text-lg font-medium text-foreground">{lastTravel.estimatedTime}</span>
                      </div>
                    </div>
                  </div>
                ))
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Número da licença</span>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-6">
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Já obteve visto nos EUA?</span>

                <span className="text-lg font-medium text-foreground">{form.USAVisaConfirmation ? "Sim" : "Não"}</span>
              </div>

              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Data de Emissão do Visto</span>
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Número do Visto</span>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">{form.newVisaConfirmation ? "Sim" : "Não"}</span>
              </div>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Forneceu digitais dos 10 dedos?</span>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Já teve um visto perdido ou roubado?</span>

                <span className="text-lg font-medium text-foreground">{form.lostVisaConfirmation ? "Sim" : "Não"}</span>
              </div>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Já teve um visto revogado ou cancelado?</span>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Já teve um visto negado?</span>
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">O que ocorreu com o visto negado</span>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Posto Consular no Brasil</span>
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Categoria/tipo de visto negado</span>
        ...
        <AccordionItem value="usa-contacts" className="bg-white p-6 flex flex-col gap-9 border-0 rounded-lg">
          <AccordionTrigger className="text-lg text-left text-foreground font-semibold hover:no-underline">
        ...
        <AccordionItem value="family" className="bg-white p-6 flex flex-col gap-9 border-0 rounded-lg">
          ...
          <AccordionContent className="w-full flex flex-col gap-9">
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Nome Completo do Pai</span>
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Data de Nascimento do Pai</span>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Pai se encontra nos EUA?</span>
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Situação do Pai</span>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Nome Completo do Mãe</span>
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Data de Nascimento do Mãe</span>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Mãe se encontra nos EUA?</span>
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Situação do Mãe</span>
            ...
            <div className="w-full grid grid-cols-1 gap-6">
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Há alguém da família nos EUA?</span>
                ...
                form.familyLivingInTheUSA.map((familyLivingInTheUSA, index) => (
                  <div key={`familyLivingInTheUSA-${index}`} className="w-full bg-[#D3D3E2] p-5 flex flex-col gap-4">
                    <div className="w-full flex flex-col sm:flex-row items-center gap-2">
                      ...
                      <span className="text-foreground text-lg text-center font-medium">Familiar</span>
                    </div>
        ...
        <AccordionItem value="work-education" className="bg-white p-6 flex flex-col gap-9 border-0 rounded-lg">
          <AccordionTrigger className="text-lg text-left text-foreground font-semibold hover:no-underline">
            Trabalho e Educação
          </AccordionTrigger>
        ...
        <AccordionItem value="additional-information" className="bg-white p-6 flex flex-col gap-9 border-0 rounded-lg">
          <AccordionTrigger className="text-lg text-left text-foreground font-semibold hover:no-underline">
          ...
          <AccordionContent className="w-full flex flex-col gap-9">
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Você participa de algum clã ou tribo?</span>
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Quais idiomas você fala?</span>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Países que viajou</span>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Organizações que você faz parte</span>
            ...
            <div className="w-full grid grid-cols-1 gap-6">
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Você tem treinamento com arma de fogo?</span>
            ...
            {form.weaponTrainingConfirmation && form.weaponTrainingDetails && (
              <div className="w-full grid grid-cols-1 gap-6">
                <div className="w-full flex flex-col gap-1">
                  <span className="text-sm text-foreground/60 font-medium">Mais detalhes sobre o treinamento</span>
            ...
            <div className="w-full grid grid-cols-1 gap-6">
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Já prestou serviço militar?</span>
            ...
            {form.militaryServiceConfirmation && (
              <>
                <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-6">
                  <div className="w-full flex flex-col gap-1">
                    <span className="text-sm text-foreground/60 font-medium">País que serviu</span>
                  ...
                  <div className="w-full flex flex-col gap-1">
                    <span className="text-sm text-foreground/60 font-medium">Local que serviu</span>
                  ...
                  <div className="w-full flex flex-col gap-1">
                    <span className="text-sm text-foreground/60 font-medium">Patente</span>
                ...
                <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-6">
                  <div className="w-full flex flex-col gap-1">
                    <span className="text-sm text-foreground/60 font-medium">Especialidade</span>
                  ...
                  <div className="w-full flex flex-col gap-1">
                    <span className="text-sm text-foreground/60 font-medium">Data de início</span>
                  ...
                  <div className="w-full flex flex-col gap-1">
                    <span className="text-sm text-foreground/60 font-medium">Data de Término</span>
            ...
            <div className="w-full grid grid-cols-1 gap-6">
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Mais detalhes sobre sua participação</span>
        ...
        <AccordionItem value="security" className="bg-white p-6 flex flex-col gap-9 border-0 rounded-lg">
          ...
          <AccordionContent className="w-full flex flex-col gap-9">
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Detalhes</span>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">{form.crimeConfirmation ? "Sim" : "Não"}</span>
              </div>
              ...
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">
                  {form.crimeConfirmationDetails ? form.crimeConfirmationDetails : "Sem detalhes"}
                </span>
              </div>
            </div>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="w-full flex flex-col gap-1">
                <span className="text-sm text-foreground/60 font-medium">Já teve problemas com drogas?</span>
              ...
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">
                  {form.drugsProblemConfirmationDetails ? form.drugsProblemConfirmationDetails : "Sem detalhes"}
                </span>
              </div>
            </div>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">
                  {form.lawViolateConfirmationDetails ? form.lawViolateConfirmationDetails : "Sem detalhes"}
                </span>
              </div>
            </div>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">
                  {form.prostitutionConfirmationDetails ? form.prostitutionConfirmationDetails : "Sem detalhes"}
                </span>
              </div>
            </div>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">
                  {form.moneyLaundryConfirmationDetails ? form.moneyLaundryConfirmationDetails : "Sem detalhes"}
                </span>
              </div>
            </div>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">
                  {form.peopleTrafficConfirmationDetails ? form.peopleTrafficConfirmationDetails : "Sem detalhes"}
                </span>
              </div>
            </div>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">{form.spyConfirmation ? "Sim" : "Não"}</span>
              </div>
              ...
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">
                  {form.spyConfirmationDetails ? form.spyConfirmationDetails : "Sem detalhes"}
                </span>
              </div>
            </div>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">
                  {form.terrorismConfirmationDetails ? form.terrorismConfirmationDetails : "Sem detalhes"}
                </span>
              </div>
            </div>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">
                  {form.terrorismMemberConfirmationDetails ? form.terrorismMemberConfirmationDetails : "Sem detalhes"}
                </span>
              </div>
            </div>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">
                  {form.parentTerrorismConfirmationDetails ? form.parentTerrorismConfirmationDetails : "Sem detalhes"}
                </span>
              </div>
            </div>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">{form.genocideConfirmation ? "Sim" : "Não"}</span>
              </div>
              ...
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">
                  {form.genocideConfirmationDetails ? form.genocideConfirmationDetails : "Sem detalhes"}
                </span>
              </div>
            </div>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">{form.tortureConfirmation ? "Sim" : "Não"}</span>
              </div>
              ...
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">
                  {form.tortureConfirmationDetails ? form.tortureConfirmationDetails : "Sem detalhes"}
                </span>
              </div>
            </div>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">{form.assassinConfirmation ? "Sim" : "Não"}</span>
              </div>
              ...
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">
                  {form.assassinConfirmationDetails ? form.assassinConfirmationDetails : "Sem detalhes"}
                </span>
              </div>
            </div>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">
                  {form.childSoldierConfirmationDetails ? form.childSoldierConfirmationDetails : "Sem detalhes"}
                </span>
              </div>
            </div>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">
                  {form.religionLibertyConfirmationDetails ? form.religionLibertyConfirmationDetails : "Sem detalhes"}
                </span>
              </div>
            </div>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">{form.abortConfirmation ? "Sim" : "Não"}</span>
              </div>
              ...
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">
                  {form.abortConfirmationDetails ? form.abortConfirmationDetails : "Sem detalhes"}
                </span>
              </div>
            </div>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">
                  {form.visaFraudConfirmationDetails ? form.visaFraudConfirmationDetails : "Sem detalhes"}
                </span>
              </div>
            </div>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">{form.deportedConfirmation ? "Sim" : "Não"}</span>
              </div>
              ...
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">
                  {form.deportedConfirmationDetails ? form.deportedConfirmationDetails : "Sem detalhes"}
                </span>
              </div>
            </div>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">
                  {form.childCustodyConfirmationDetails ? form.childCustodyConfirmationDetails : "Sem detalhes"}
                </span>
              </div>
            </div>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">
                  {form.lawViolationConfirmationDetails ? form.lawViolationConfirmationDetails : "Sem detalhes"}
                </span>
              </div>
            </div>
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">{form.avoidTaxConfirmation ? "Sim" : "Não"}</span>
              </div>
              ...
              <div className="w-full flex flex-col gap-1">
                ...
                <span className="text-lg font-medium text-foreground">
                  {form.avoidTaxConfirmationDetails ? form.avoidTaxConfirmationDetails : "Sem detalhes"}
                </span>
              </div>
            </div>

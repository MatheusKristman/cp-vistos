          ...
          >
            ...
            <div className="w-full flex flex-col gap-2 lg:max-w-prose">
              ...
              <motion.p variants={itemAnimation} className="about-text-animation text-base text-foreground/70">
                ...
                eficiente e personalizado. Nosso compromisso é tornar o processo mais claro e humanizado, garantindo que
                você se sinta confiante e amparado(a) em cada etapa, enquanto se concentra na realização dos seus sonhos
                e planos nos Estados Unidos.
              </motion.p>
            </div>
          </motion.div>
        </div>

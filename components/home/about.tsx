            ...
            >
              ...
              <div className="w-full flex flex-col gap-2 lg:max-w-prose">
                <motion.p variants={itemAnimation} className="about-text-animation text-base text-foreground/70">
                  ...
                  consulado americano, o que me proporcionou um conhecimento amplo e profundo sobre o processo de
                  obtenção de vistos.
                </motion.p>

                <motion.p variants={itemAnimation} className="about-text-animation text-base text-foreground/70">
                  Essa vivência me motivou a criar uma agência que simplifica essa jornada, oferecendo um serviço
                  eficiente e personalizado. Nosso compromisso é tornar o processo mais claro e humanizado, garantindo
                  que você se sinta confiante e amparado(a) em cada etapa, enquanto se concentra na realização dos seus
                  sonhos e planos nos Estados Unidos.
                </motion.p>
              </div>
            </motion.div>
          </div>

  ...
  return (
    <section className="w-full flex flex-col sm:grid sm:grid-cols-2">
      <div className="w-full aspect-square sm:aspect-auto relative">
        <Image src="/assets/images/home-about.jpg" alt="Camila Prado" fill className="object-center object-cover" />
      </div>

      <div className="w-full px-6 sm:px-9 lg:px-20 py-24 bg-[#FAF5E8] flex flex-col justify-center gap-6">
        <div className="flex flex-col gap-4">
          <h2 className="text-2xl sm:text-3xl lg:text-5xl text-foreground font-medium">Sobre</h2>

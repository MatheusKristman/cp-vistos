  ...
  return (
    <section className="w-full flex flex-col sm:grid sm:grid-cols-2">
      <div className="w-full px-6 sm:px-16 py-9 sm:py-20 border-t sm:border-b border-secondary">
        <h2 className="text-2xl sm:text-3xl lg:text-5xl text-foreground font-medium mb-6">
          Nossos Diferenciais
        </h2>
        ...
        <div className="w-full flex flex-col gap-4 relative before:content-[''] before:absolute before:top-0 before:left-[17px] before:h-full before:w-[2px] before:bg-primary">
          <div className="w-full flex gap-4">
            ...
            <div className="pt-1">
              <h3 className="text-xl sm:text-2xl text-foreground font-medium mb-2">
              ...
              <p className="text-base sm:text-lg text-foreground">
                ...
                sinta genuinamente valorizado e compreendido.
              </p>
            </div>
          </div>
          ...
          <div className="w-full flex gap-4">
            ...
            <div className="pt-1">
              ...
              <p className="text-base sm:text-lg text-foreground">
                ...
                serviço, nossa equipe está empenhada em oferecer soluções sob
                medida para você.
              </p>
            </div>
          </div>
          ...
          <div className="w-full flex gap-4">
            ...
            <div className="pt-1">
              ...
              <p className="text-base sm:text-lg text-foreground">
                ...
                sinta confortável e valorizado em cada contato.
              </p>
            </div>
          </div>
        </div>

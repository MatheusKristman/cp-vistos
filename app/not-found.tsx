...
export default function NotFoundPage({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <>
      <Header />
      ...
      <div className="w-full h-[calc(100vh-80px)] flex flex-col gap-6 items-center justify-center md:gap-10">
        <div className="flex flex-col gap-4 justify-center items-center md:gap-9">
          ...
          <span className="text-xl font-medium text-center md:text-2xl">Página não encontrada</span>
        </div>

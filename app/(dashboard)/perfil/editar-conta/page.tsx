...
export default function EditAccountPage() {
  ...
  return (
    <div className="w-full px-6 sm:px-16 mt-6 lg:mt-10 mb-12">
      <h1 className="text-2xl sm:text-3xl lg:text-4xl font-medium mb-6">Criar contas</h1>

      <div className="w-full flex flex-col gap-12 lg:flex-row-reverse">
        <div
          className={cn("w-full lg:w-1/2 h-fit bg-secondary px-6 py-4 flex flex-col items-center opacity-100", {
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 lg:w-1/2">
            <div className="w-full flex flex-col space-y-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-base text-primary">E-mail</FormLabel>

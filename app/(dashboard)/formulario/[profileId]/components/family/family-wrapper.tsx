...
export const FamilyWrapper = ({ profileId, isEditing, isMinor, loading }: FamilyWrapperProps) => {
  const { data: familyForm, isPending } = trpc.formsRouter.getFamily.useQuery({ profileId });
  ...
  return <FamilyForm familyForm={familyForm} profileId={profileId} isEditing={isEditing} isMinor={isMinor} />;
};

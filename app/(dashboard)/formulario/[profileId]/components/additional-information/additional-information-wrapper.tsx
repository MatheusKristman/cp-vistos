...
interface AdditionalInformationWrapperProps {
  profileId: string;
  isEditing: boolean;
  loading: boolean;
}

export const AdditionalInformationWrapper = ({ profileId, isEditing, loading }: AdditionalInformationWrapperProps) => {
  const { data: additionalInformationForm, isPending } = trpc.formsRouter.getAdditionalInformation.useQuery({
    profileId,
  });
